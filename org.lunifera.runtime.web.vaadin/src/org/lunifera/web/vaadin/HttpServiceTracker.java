 ...
 * {@link SessionRegister} class which is then registered as a
...
public class HttpServiceTracker extends ServiceTracker {
	...
	private Map<ExtendedHttpService, SessionRegister> configs = new IdentityHashMap<ExtendedHttpService, SessionRegister>();
	...
	public Object addingService(ServiceReference reference) {
		...
		SessionRegister config = new SessionRegister(http, factory,
				alias);
