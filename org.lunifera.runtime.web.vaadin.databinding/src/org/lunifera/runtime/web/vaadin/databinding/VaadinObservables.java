...
public class VaadinObservables {
	 ...
	 * 
	 * @param ui
	 * @param autoSynchronize synchronize multipe vaadin ui's
	 */
	...
	/**
	 * Returns an observable value tracking the propertyset of the given item notifier.
	 * 
	 * @param notifier
	 * @return
	 */
	...
	/**
	 * Returns an observable list tracking the item set of the given item notifier.
	 * 
	 * @param notifier the field
	 ...
	 * 
	 * @param notifier
	 * @param type - the type of the selection object
	 * @return
	 */
	public static IVaadinObservableValue observeSingleSelection(Property.ValueChangeNotifier notifier, Class<?> type) {
		return VaadinProperties.singleSelection(type).observe(notifier);
	}

	/**
	 * Returns an observable value tracking nested attribute in the selected element.
	 * <p>
	 * For instance:<br>
	 * Given a list with Bar-beans. Bar has a relation to Foo-bean by myfoo-reference.<br>
	 * Then "myFoo.name" can be used as nestedPath to observe the foo#name attribute of the selected bean in the list.
	 * <p>
	 * This implementation supports pojos and beans. EObjects are not supported.
	 * 
	 * @param notifier
	 * @param type - the type of the selection object
	 * @param nestedPath - the path from the selected element to the observed value. For instance "myFoo.name".
	 * @return
	 */
	...
	private static boolean hasPropertyChangeSupport(Class<?> valueType) {
		...
		try {
			try {
				method = valueType.getMethod("addPropertyChangeListener", new Class[] { String.class,
						PropertyChangeListener.class });
				return true;
			} catch (NoSuchMethodException e) {
				method = valueType.getMethod("addPropertyChangeListener", new Class[] { PropertyChangeListener.class });
				return true;
			}
	...
	/**
	 * Returns an observable list tracking the multi selection of the given viewer.
	 * 
	 * @param notifier
	 * @param collectionType the type contained in the multi selection
	 * @return
	 */
	...
	/**
	 * Returns an observable set tracking the multi selection of the given viewer.
	 * 
	 * @param notifier
	 * @param collectionType the type contained in the multi selection
	 * @return
	...
	/**
	 * Returns an observable value tracking the converted value of the given field.
	 * 
	 * @param field
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the readonly state of the given notifier.
	 * 
	 * @param notifier
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the focus state of the given focusable. Note that isFocus() can not be
	 * returned. You can only use setFocus().
	 * 
	 * @param field
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the primary style name of the given widget.
	 * 
	 * @param field
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the visible state of the given widget.
	 * 
	 * @param field
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the required state of the given widget.
	 * 
	 * @param field
	 * @return
	 */
	...
	/**
	 * Returns an observable value tracking the "required error message" of the given widget.
	 * 
	 * @param field
	 * @return
	 */
