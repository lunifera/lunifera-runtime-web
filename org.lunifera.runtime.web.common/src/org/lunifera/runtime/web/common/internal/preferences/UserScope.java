 ...
 */
package org.lunifera.runtime.web.common.internal.preferences;
 ...
 * <p>
 * User preferences are stored on a per user basis in the user's
 * content area as specified by <code>IUserInfo#getLocation</code>.
 * </p>
 * <p>
 * The path for preferences defined in the user scope hierarchy is as
 * follows: <code>/user/&lt;username&gt;/&lt;qualifier&gt;</code>
 * </p>
 * <p>
 ...
 */
public final class UserScope implements IScopeContext {
