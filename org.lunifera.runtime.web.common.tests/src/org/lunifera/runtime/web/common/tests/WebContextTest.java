...
public class WebContextTest {
	...
	public void test_createAndDispose() {
		...
		IWebContext context = registry.createContext("user1");
	...
	public void test_userInfo() {
		...
		IEclipsePreferences preferences = info.getPreferences("tests");
	...
	public void test_userPreferences() {
		...
		// user 2
		//
		IWebContext context2_1 = registry.createContext("user2");
		IUserInfo info2_1 = context2_1.getUserInfo();
		IEclipsePreferences preferences2_1 = info2_1.getPreferences("tests");
		Assert.assertNull(preferences2_1.get("test1", null));

		// user 1
		//
		IWebContext context1_2 = registry.createContext("user1");
		IUserInfo info1_2 = context1_2.getUserInfo();
		IEclipsePreferences preferences1_2 = info1_2.getPreferences("tests");
