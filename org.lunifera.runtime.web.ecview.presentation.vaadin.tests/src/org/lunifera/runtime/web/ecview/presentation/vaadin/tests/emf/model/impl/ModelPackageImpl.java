...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see org.lunifera.runtime.web.ecview.presentation.vaadin.tests.emf.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(emfFooEClass, EmfFoo.class, "EmfFoo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEmfFoo_Name(), ecorePackage.getEString(), "name", null, 0, 1, EmfFoo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(emfBarEClass, EmfBar.class, "EmfBar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEmfBar_Name(), ecorePackage.getEString(), "name", null, 0, 1, EmfBar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEmfBar_Myfoo(), this.getEmfFoo(), null, "myfoo", null, 0, 1, EmfBar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
