...
import org.lunifera.runtime.web.ecview.presentation.vaadin.internal.VerticalLayoutPresentation;
...
public class VerticallLayoutPresentationTests{
	...
	public void test_removeField_AddAndInsert_byModel() throws Exception {
		...
		VerticalLayout layout = (VerticalLayout) unwrapLayout(layoutPres
				.getWidget());
